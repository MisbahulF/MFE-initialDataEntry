...
export const MFE_EVENTS = {
  // Business Loan Workflow Events
  APPLICATION_SENT_TO_PROCESSING: 'APPLICATION_SENT_TO_PROCESSING',
  DATA_ENTRY_MENU_SELECT: 'DATA_ENTRY_MENU_SELECT',
  DATA_ENTRY_UPDATE_STATUS: 'DATA_ENTRY_UPDATE_STATUS',
  REFRESH_PROSPECTS: 'REFRESH_PROSPECTS',
